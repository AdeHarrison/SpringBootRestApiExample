...
public class RestApiController {
    ...
    public ResponseEntity<List<User>> listAllUsers2() {
        final String uri = "http://192.168.99.100:31471/SpringBootRestApi2/api/user/";
...
//        ResponseEntity<List<User>> response = restTemplate.exchange("http://192.168.99.100:31471/SpringBootRestApi2/api/user/",
//                HttpMethod.GET,
//                null,
//                new ParameterizedTypeReference<List<User>>() {
//                });
        ...
        List<User> users2 = response.getBody();
